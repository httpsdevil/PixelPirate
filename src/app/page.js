                                ...
                                {userData && (
                                    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 flex flex-col items-center">
                                        ...
                                        <div className="mb-6 px-4 py-2 rounded-lg bg-slate-100 border border-slate-200 text-sm flex items-start gap-3">
                                            ...
                                            <button
                                                onClick={handleCopy}
                                                className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-300 whitespace-nowrap cursor-pointer
                                                        ${copied
                                        ...
                                        <button
                                            onClick={handleBack}
                                            className="mb-6 flex items-center gap-2 text-sm text-slate-500 hover:text-slate-800 transition font-semibold cursor-pointer"
                                        >
                                        ...
                                        {platform === "youtube" && userData.name && userData.thumbnails && (
                                            <button
                                                ...
                                                className={`mt-4 px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 cursor-pointer
                                                        ${titleCopied
                                                        ? "bg-green-500 text-white"
